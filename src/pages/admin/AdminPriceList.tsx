  ...
  return (
    <div className="flex flex-col h-[calc(100vh-7rem)] space-y-6">
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to delete "${itemToDelete?.description || ''}"? It will be hidden from new services, but will be kept in the database for historical and traceability purposes.`}
        confirmLabel="Delete"
        cancelLabel="Cancel"
        isDestructive={true}
